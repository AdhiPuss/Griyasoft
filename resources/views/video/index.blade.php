                    ...
                    @foreach($videos as $video)
                        <tr >
                            ...
                            <td style="width: 10%;">
                                ...
                                <a href="{{ route('video.play', $video->id) }}" class="btn btn-sm btn-info">Play</a>
                                <a href="{{ asset($video->file_path) }}" class="btn btn-sm btn-primary" download>Download</a>
                                <button class="btn btn-danger btn-sm" data-image-id="{{ $video->id }}" data-action="{{route ('video.destroy',$video->id) }}" onclick="deleteConfirmation({{$video->id}})" data-toggle="tooltip" title='Delete' style="margin-left: 8px"><i class="nav-icon fas fa-trash-alt"></i> &nbsp; Hapus</button>
